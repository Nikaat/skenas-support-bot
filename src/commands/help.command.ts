...
export const helpCommand = {
  ...
  handler: async (ctx: Context): Promise<void> => {
    try {
      const helpText = `
🤖 <b>ربات هشدار تراکنش‌های ناموفق و درحال بررسی - راهنما</b>
...
<b>هدف ربات:</b>
این ربات برای دریافت هشدارهای تراکنش‌های ناموفق و درحال بررسی از برنامه اصلی طراحی شده است.

<b>نحوه استفاده:</b>

1️⃣ از /start برای احراز هویت ادمین استفاده کنید
2️⃣ شماره تلفن خود را به اشتراک بگذارید
3️⃣ پس از تأیید، هشدارهای تراکنش‌های ناموفق و درحال بررسی را دریافت خواهید کرد
